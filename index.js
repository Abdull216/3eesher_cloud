// ==================== COMPLETE 3EESHER.CLOUD - FULLY FIXED ====================
...
// Initialize Firebase Admin with ALL required options
admin.initializeApp({
  credential: admin.credential.cert(serviceAccount),
  databaseURL: "https://allarbaa-com-default-rtdb.firebaseio.com",
  storageBucket: "allarbaa-com.appspot.com" // ✅ FIXED: Added storage bucket
});
...
app.listen(PORT, '0.0.0.0', () => {
    ...
    console.log(`   - Storage Bucket: allarbaa-com.appspot.com`);
    console.log(``);
