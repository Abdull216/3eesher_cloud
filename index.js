    ...
    <div class="main">
        ...
        <div id="inject" class="panel">
            ...
            <form action="/admin/save-injections" method="POST"><div class="grid">
                ...
                <div><label>Custom HTML Widgets (Added anywhere)</label><textarea name="customHtml" rows="4" placeholder="<div>Your HTML Widget</div>">${data.injections.customHtml||''}</textarea></div>
